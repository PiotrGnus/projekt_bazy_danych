		...
		<body>	
			...
			<section class="item-category-area section-gap">
				<div class="container">
						...
						<div class="col-md-12 pb-80 header-text text-center">
                            ...
                            <?php
                                ...
                                if ( isset($_POST['submit']) ){
                                    ...
                                    $sql = oci_parse($conn,"BEGIN GET_OFERTA(:firm, :wymiar, :PLOUG_CURSOR); END;");
                                        oci_bind_by_name($sql, ':firm', $firma);
                                        oci_bind_by_name($sql, ':wymiar', $wymiar);
                                        ...
                                        while ($result = oci_fetch_array($cursor, OCI_BOTH)) {
                                            echo '
                                                <tr>
                                                    <td>'.$result["NAZWA"].'</td>
                                                    <td>'.$result["WYMIAR_PRACY"].'</td>
                                                    <td>'.$result["STAWKA_DZIEN"].'</td>
                                                    <td>'.$result["ILOSC_OFERT"].'</td>
                                                </tr>
                                            ';
                                        }
					...
					<div class="row">
                        <form action="show_oferty.php" method="post">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="list-group">
                                        <label></label><input class="list-group-item" type="text" name="firma" placeholder="Firma">
                                        <label></label><input class="list-group-item" type="text" name="wymiar" placeholder="Wymiar Pracy">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="list-group">
