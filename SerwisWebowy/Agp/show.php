		...
		<body>	
			...
			<section class="item-category-area section-gap">
				<div class="container">
					...
					<div class="row">
                        <a class="primary-btn mx-auto mt-80" href="show_kontrahentow.php">Kontrahenta</a>
                        <a class="primary-btn mx-auto mt-80" href="show_oferty.php">Oferty</a>
                        <a class="primary-btn mx-auto mt-80" href="show_firmy.php">Firmy</a>
					</div>
				</div>
			</section>
