	...
	<head>
		...
		<body>	
			...
			<section class="item-category-area section-gap">
				<div class="container">
					<div class="row d-flex justify-content-center"><div></div>
						<div class="col-md-12 pb-80 header-text text-center">
                            <h2><br>Panel zarządzania bazą danych</h2>
                            <h3>Wybierz działanie</h3>
						</div>
                        <h2 style="text-align: center; color: red;"><?php if( isset($_SESSION['dbconnect']) != 'OK' ) {echo 'Brak połączenia z bazą<br>';}
                                if( isset($_SESSION['formstate']) ){echo $query;}
                            ?>
                        </h2>
					</div>
					<div class="row">
                        <a class="primary-btn mx-auto mt-80" href="add.php">Dodaj</a>
                        <a class="primary-btn mx-auto mt-80" href="show.php">Wyświetl</a>
                        <a class="primary-btn mx-auto mt-80" href="update.php">Aktualizuj</a>
					</div>
				</div>
			</section>
