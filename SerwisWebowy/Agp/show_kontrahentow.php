		...
		<body>	
			...
			<section class="item-category-area section-gap">
				<div class="container">
						...
						<div class="col-md-12 pb-80 header-text text-center">
                            ...
                            <?php
                                ...
                                if ( isset($_POST['submit']) ){
                                    ...
                                    $sql = oci_parse($conn,"BEGIN GET_KONTRAHENT(:IMIE, :NAZWISKO, :PLOUG_CURSOR); END;");
					...
					<div class="row">
                        <form action="show_kontrahentow.php" method="post">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="list-group">
                                        <label></label><input class="list-group-item" type="text" name="imie" aria-label="Imie" placeholder="Imie">
                                        <label></label><input class="list-group-item" type="text" name="nazwisko" placeholder="Nazwisko">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="list-group">
