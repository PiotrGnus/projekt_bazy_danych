                        ...
                        <h2 style="text-align: center; color: red;">
                            <?php
                                ...
                                if ( isset($_POST['submit']) ){
                                    try {
                                        $firma = ucwords($_POST['firma']);
                                        $wymiar = ucwords($_POST['wymiar']);
                                    $sql = oci_parse($conn,"BEGIN UPDATE_OFERTY(:ILOSC_OFERT, :OPIS, :FIRMA, :WYMIAR_PRACY); COMMIT; END;");
                                        oci_bind_by_name($sql, ':ILOSC_OFERT', $_POST['ilosc']);
                                        oci_bind_by_name($sql, ':OPIS', $_POST['opis']);
                                        oci_bind_by_name($sql, ':FIRMA', $firma);
                                        oci_bind_by_name($sql, ':WYMIAR_PRACY', $wymiar);
                                        oci_bind_by_name($sql, ':STAWKA', $_POST['dzien']);
                                        oci_bind_by_name($sql, ':STANOWISKO', $_POST['id_stanowiska']);
                                        oci_execute($sql);
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="list-group">
                                        ...
                                        <label>Ilość ofert</label><input class="list-group-item" type="number" min="0" name="ilosc" placeholder="15">
                                        <label>Opis</label><textarea class="list-group-item" type="text" name="opis" rows="3" cols="50" placeholder="Oferta pracy"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="list-group">
                                        <h3 style="text-align: center;">Gdzie</h3>
                                        <label>*Firma</label><input class="list-group-item" type="text" name="firma" placeholder="Nazwa" required>
                                        ...
                                        <label>*Stanowisko</label><input class="list-group-item" type="number" min="1" name="id_stanowiska" placeholder="id Stanowiska" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="list-group">
