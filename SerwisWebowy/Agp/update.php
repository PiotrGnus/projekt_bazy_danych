		...
		<body>	
			...
			<section class="item-category-area section-gap">
				<div class="container">
					...
					<div class="row">
                        <a class="primary-btn mx-auto mt-80" href="update_biuro.php">Biuro</a>
                        <a class="primary-btn mx-auto mt-80" href="update_oferta.php">Ofertę</a>
                        <a class="primary-btn mx-auto mt-80" href="update_kontrahent.php">Kontrahenta</a>
					</div>
				</div>
			</section>
