		...
		<body>	
			...
			<section class="item-category-area section-gap">
				<div class="container">
                        ...
                        <h2 style="text-align: center; color: red;">
                            <?php
                                ...
                                if ( isset($_POST['submit']) ){
                                    try {
                                        $nazwa = $_POST['nazwa'];
                                        $sql = oci_parse($conn,"BEGIN CREATE_STANOWISKO (:STANOWISKO_NAZWA); END;");
                                        oci_bind_by_name($sql, ':STANOWISKO_NAZWA', $nazwa);
                                        oci_execute($sql);
					...
					<div class="row">
                        <form action="add_stanowisko.php" method="post">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="list-group">
                                        <label>Stanowisko</label><input class="list-group-item" type="text" name="nazwa" placeholder="Nazwa" required>                                    </div>
                                </div>
